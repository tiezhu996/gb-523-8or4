...
export class ScenarioApi {
  ...
  setPins(id: number, version: number, pins: RackPinInput[]): Observable<LayoutScenario> {
    return this.api.put(`/scenarios/${id}/pins`, {version, pins});
  }
